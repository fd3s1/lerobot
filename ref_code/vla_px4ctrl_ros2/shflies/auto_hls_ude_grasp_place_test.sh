...
echo "[auto-hls-ude-test] mocap correction: enable=${MOCAP_CORRECTION_ENABLE} max_xy=${MOCAP_CORRECTION_MAX_XY_M} max_z=${MOCAP_CORRECTION_MAX_Z_M} vxy=${MOCAP_CORRECTION_VXY_MPS} vz=${MOCAP_CORRECTION_VZ_MPS} hls_xy_vmax=${MOCAP_CORRECTION_HLS_XY_VMAX_MPS} freeze_z_on_contact=${MOCAP_CORRECTION_FREEZE_Z_ON_CONTACT}"
...
export MOCAP_CORRECTION_FREEZE_Z_ON_CONTACT HLS_GRASP_MAX_RETRIES
