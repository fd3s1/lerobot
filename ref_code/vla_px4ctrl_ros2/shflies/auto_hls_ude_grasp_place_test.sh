...
TARGET_GRASP_Z_BIAS_M="${TARGET_GRASP_Z_BIAS_M:--0.06}"
...
WAYPOINT_ARRIVAL_XY_TOLERANCE_M="${WAYPOINT_ARRIVAL_XY_TOLERANCE_M:-0.12}"
WAYPOINT_ARRIVAL_Z_TOLERANCE_M="${WAYPOINT_ARRIVAL_Z_TOLERANCE_M:-0.08}"
...
CENTER_VMAX_MPS="${CENTER_VMAX_MPS:-0.015}"
CENTER_OFFSET_MAX_M="${CENTER_OFFSET_MAX_M:-0.025}"
...
echo "[auto-hls-ude-test] grasp z: target_grasp_z_offset=${TARGET_GRASP_Z_OFFSET:-<auto>} target_grasp_z_bias=${TARGET_GRASP_Z_BIAS_M}"
echo "[auto-hls-ude-test] arrival gates: waypoint_xy=${WAYPOINT_ARRIVAL_XY_TOLERANCE_M} waypoint_z=${WAYPOINT_ARRIVAL_Z_TOLERANCE_M} pregrasp_xy=${PREGRASP_ARRIVAL_XY_TOLERANCE_M} pregrasp_z=${PREGRASP_ARRIVAL_Z_TOLERANCE_M} pregrasp_z_speed=${PREGRASP_Z_SPEED_MPS}"
...
echo "[auto-hls-ude-test] hls centering assist: center_vmax=${CENTER_VMAX_MPS} center_offset_max=${CENTER_OFFSET_MAX_M} snapshot_mismatch_tol=${HLS_STATUS_CENTER_MISMATCH_TOL_M}"
...
export TARGET_HOVER_Z_OFFSET TARGET_GRASP_Z_OFFSET TARGET_GRASP_Z_BIAS_M BOX_HOVER_Z_OFFSET BOX_PLACE_Z_OFFSET
...
export WAYPOINT_ARRIVAL_SETTLE_S WAYPOINT_ARRIVAL_TIMEOUT_S POST_TAKEOFF_SETTLE_S
...
export CENTER_VMAX_MPS CENTER_OFFSET_MAX_M HLS_STATUS_CENTER_MISMATCH_TOL_M HLS_GRASP_MAX_RETRIES
