...
HLS_GRIP_CHASE_POSITION_SPEED="${HLS_GRIP_CHASE_POSITION_SPEED:-28}"
HLS_GRIP_CHASE_POSITION_ACC="${HLS_GRIP_CHASE_POSITION_ACC:-10}"
...
OPEN_MODE_STABLE_S="${OPEN_MODE_STABLE_S:-0.7}"
