...
HLS_LIFT_CURRENT="${HLS_LIFT_CURRENT:-900}"
...
HOLD_MODE_TIMEOUT_S="${HOLD_MODE_TIMEOUT_S:-1.0}"
...
echo "[handheld-hls-grasp-test] contact: enter=${HLS_CONTACT_CURRENT_THRESHOLD} exit=${HLS_CONTACT_EXIT_THRESHOLD} strong=${HLS_CONTACT_STRONG_THRESHOLD} confirm_cycles=${HLS_CONTACT_CONFIRM_CYCLES}"
