...
// {
// 	if(odom_data.p[0]>=6.5 && cmd_data.a[0]>=1e-6)
// 	{
// 		ROS_INFO("collision front");
// 		return 1;
// 	}
// 	else if(odom_data.p[0]<=-6.5 && cmd_data.a[0]<=-1e-6)
// 	{
// 		ROS_INFO("collision rear");
// 		return 2;
// 	}
// 	else if(odom_data.p[1]>=3.5 && cmd_data.a[1]>=1e-6)
// 	{
...
void PX4CtrlFSM::set_hov_with_odom()
{
	...
	//ROS_INFO("set_hov_with_odom");
	cout << "odom_data.p=" << odom_data.p.transpose() << endl;
...
void PX4CtrlFSM::set_hov_with_rc()
{
	...
	// hover_pose(0) += rc_data.ch[1] * param.max_manual_vel * 1 * (param.rc_reverse.pitch ? 1 : -1);
	// hover_pose(1) += rc_data.ch[0] * param.max_manual_vel * 1 * (param.rc_reverse.roll ? 1 : -1);
	// hover_pose(2) += rc_data.ch[2] * param.max_manual_vel * delta_t * (param.rc_reverse.throttle ? 1 : -1);
	// hover_pose(3) += rc_data.ch[3] * param.max_manual_vel * 1 * (param.rc_reverse.yaw ? 1 : -1);
