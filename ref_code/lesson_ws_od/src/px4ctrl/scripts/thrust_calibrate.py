...
class ThrustCalibration:
    ...
    def __init__(self):
        ...
        self.bat_sub = rospy.Subscriber(
            "/drone6/mavros/battery", BatteryState, self.battery_voltage_cb)
        rospy.Subscriber(
            "/drone6/mavros/setpoint_raw/attitude", AttitudeTarget, self.thrust_commands_cb)
        rospy.Subscriber(
            "/drone6/traj_start_trigger", PoseStamped, self.start_trigger_cb)
