...
def main():
    ...
    model = YOLO("/home/uav01/lesson_ws/src/yolov5_trt/pynodes/yolov8/qrcode_best.pt")#best.pt只能检测人体
    ...
    while True:
        ...
        rs_targets_pub = rospy.Publisher('/drone6/yolov8_detector/realsense_targets', RealsenseTargets, queue_size=5)
